...
class Utility {
    ...
    static buildMail(target, title, link) {
        ...
        return {
            sender: "melwindsouza0311@gmail.com" ,//process.env.MAIL_USER,
    ...
    static async sendMail(mailOptions) {
        let mailTransporter = (0, nodemailer_1.createTransport)({
            ...
            secure: true,
            auth: {
                user: "melwindsouza0311@gmail.com",//process.env.MAIL_USER,
                pass: "kiaz nskr lgzr bpln",//process.env.MAIL_PW,
            }
        });
